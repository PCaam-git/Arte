...
parcelHelpers.export(exports, "fetchObras", ()=>fetchObras);
parcelHelpers.export(exports, "fetchObra", ()=>fetchObra);
parcelHelpers.export(exports, "createObra", ()=>createObra);
parcelHelpers.export(exports, "updateObra", ()=>updateObra);
parcelHelpers.export(exports, "deleteObra", ()=>deleteObra);
const API_URL = 'http://localhost:8090/api/obras';
const fetchObras = async ()=>{
    const response = await fetch(API_URL);
    return await response.json();
};
const fetchObra = async (id)=>{
